...
import com.example.haekalacademy.R
import com.example.haekalacademy.utils.DataDummy
import com.example.haekalacademy.utils.EspressoIdlingResources
...
class HomeActivityTest {
    ...
    fun setUp() {
        ...
        IdlingRegistry.getInstance().register(EspressoIdlingResources.idlilingResource)
    }

    @After
    fun tearDown() {
        IdlingRegistry.getInstance().unregister(EspressoIdlingResources.idlilingResource)
    }
